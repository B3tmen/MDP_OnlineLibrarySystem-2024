...
public class RedisBookService {
    ...
    public void saveBook(Book book){
        String bookKey = "lib:book:" + book.getIsbn();
        Gson gson = new Gson();
    ...
    public List<Book> getAllBooks(){
        ...
        do {
            ...
            ScanParams scanParams = new ScanParams().match("lib:book:*");
    ...
    public void deleteBook(Book book){
        String bookKey = "lib:book:" + book.getIsbn(); // Replace with your book key
