...
public class RequestSenderUtil {
    public static <T> void loadObservableList(Supplier<List<T>> serviceMethod, ObservableList<T> observableList) {
        RequestSenderService<T> service = new RequestSenderService<>(serviceMethod);
